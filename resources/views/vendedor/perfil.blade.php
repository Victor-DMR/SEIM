    ...
    <div class="conte_row row justify-content-center">
        <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 bgconten">
            ...
            <div class="row text-center mb-5 mt-3 justify-content-center">
                <div class="col-12">
                    <div class="portada">
                        <img src="{{asset('img/portada.jpg')}}" alt="img portada">
                    </div>
                    <div class="perfil">
                        <img src="{{asset('img/portada2.jpg')}}" alt="img portada">
                    </div>
                        ...
                        <div class="col-12">
                            <div class="row justify-content-center">
                                <div class="col-md-3 col-sm-2 col-3 fotosdeproducto">
                                    <img src="{{asset('img/portada.jpg')}}" alt="img1">
                                </div>
                                <div class="col-md-3 col-sm-2 col-3 fotosdeproducto">
                                    <img src="{{asset('img/portada.jpg')}}" alt="img2">
                                </div>
                                <div class="col-md-3 col-sm-2 col-3 fotosdeproducto">
                                    <img src="{{asset('img/portada.jpg')}}" alt="img3">
                                </div>
                                <div class="col-md-3 col-sm-2 col-3 fotosdeproducto">
                                    <img src="{{asset('img/portada.jpg')}}" alt="img3">
                                </div>
