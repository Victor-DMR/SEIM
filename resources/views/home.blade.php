            ...
            <div class="col-sm-12 col-md-10 col-lg-10 col-xl-8">
                <div class="row">
                    <div class="col-sm-12 text-center col-md-12 col-lg-2 logo">
                        <img id="logprimary" src="{{ asset('img/LogoSEIM2.webp') }}" alt="">
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-8 text-center">
                        <h2 id="tituloPrincipal"><strong>¡Bienvenidos!</strong></h2>
                        ...
                        <div class="row">
                            <div class="col-md-11 col-sm-11 col-lg-11 inputBuscar">
                                <form action="{{ route('busqueda') }}" method="GET">
                                    <input name="search" type="text" placeholder="¿Qúe estás necesitando?">
                                    <button class="btn-shearch" type="submit">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="row ">
                            <div class="col-6 col-md-6 pt-2  col-lg-6 categoriaenhome ">
                                <img src="{{ asset('img/portada.webp') }}" alt="">
                                <p>Moda</p>
                            </div>
                            <div class="col-6 col-md-6 pt-2  col-lg-6 categoriaenhome ">
                                <img src="{{ asset('img/portada.webp') }}" alt="">
